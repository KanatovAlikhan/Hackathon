...
boat_image = pygame.image.load("images/boat.png")  # Замените "boat_image.png" на путь к вашему файлу изображения лодки
island_image = pygame.image.load("images/island.png")  # Замените "island_image.png" на путь к вашему файлу изображения острова
